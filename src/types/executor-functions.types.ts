...
export type ExecutorFunction<NebulaType extends AtomicNebulaInterface = AtomicNebulaInterface> = 
  ...
  ((app: AtomicSingularitySystem) => boolean | void | null | undefined) | 
  (() => boolean | void | null | undefined);

export type AsyncActivationFunction<NebulaType extends AtomicNebulaInterface = AtomicNebulaInterface> =
  ((nebula: NebulaType) => Promise<boolean>) | 
  (() => Promise<boolean>);